			...
			<Layout mobile={mobile}>
				...
				>
					...
					<p>
						...
						<a href="https://docs.opencv.org/2.4/modules/imgproc/doc/filtering.html?highlight=gaussianblur#gaussianblur">
							Gaussian Blur algorithm.
						</a>{" "}
						We do this to prevent noise from showing up when we
					...
					<p>
						...
						<a href="https://docs.opencv.org/3.4/da/d22/tutorial_py_canny.html">
					...
					<p>
						We're a lot closer to having the final lane lines, but
					...
					<p>
						...
						of lines from the last step and use the{" "}
						<a>cv2.line()</a> function to draw the lines on the
						original image.{" "}
					</p>
					<pre>
						<code className="language-python">
					...
					<p>
						There's a{" "}
						<a href={"https://replit.com/@DylanMashini/Lane-Lines"}>
							playground
						</a>{" "}
