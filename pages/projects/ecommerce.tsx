	...
	return (
		<div>
			...
			>
				...
				<h2>Features</h2>
				<h4>
					I added support for accounts, promo codes, newsletter sign
					up, and payment using stripe.
				</h4>
				<h2>In Progress Features</h2>
				<h4>Multi Store Sync</h4>
				<h5>
					&nbsp;&nbsp;&nbsp;&nbsp;Sync inventory between two or more
					clover stores and automatically set order to fulfill in
					store based on stock
				</h5>
